...
// Wed Mar 18 13:49:51 2020 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: D8BCDB81-4844-E811-A71C-0025904C5DE0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[78];   //[nGenPart]
   Float_t         GenPart_mass[78];   //[nGenPart]
   Float_t         GenPart_phi[78];   //[nGenPart]
   Float_t         GenPart_pt[78];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[78];   //[nGenPart]
   Int_t           GenPart_pdgId[78];   //[nGenPart]
   Int_t           GenPart_status[78];   //[nGenPart]
   Int_t           GenPart_statusFlags[78];   //[nGenPart]
   ...
   UInt_t          nJet;
   Float_t         Jet_area[169];   //[nJet]
   Float_t         Jet_btagCMVA[169];   //[nJet]
   Float_t         Jet_btagCSVV2[169];   //[nJet]
   Float_t         Jet_btagDeepB[169];   //[nJet]
   Float_t         Jet_btagDeepC[169];   //[nJet]
   Float_t         Jet_btagDeepFlavB[169];   //[nJet]
   Float_t         Jet_chEmEF[169];   //[nJet]
   Float_t         Jet_chHEF[169];   //[nJet]
   Float_t         Jet_eta[169];   //[nJet]
   Float_t         Jet_mass[169];   //[nJet]
   Float_t         Jet_neEmEF[169];   //[nJet]
   Float_t         Jet_neHEF[169];   //[nJet]
   Float_t         Jet_phi[169];   //[nJet]
   Float_t         Jet_pt[169];   //[nJet]
   Float_t         Jet_qgl[169];   //[nJet]
   Float_t         Jet_rawFactor[169];   //[nJet]
   Float_t         Jet_bReg[169];   //[nJet]
   Int_t           Jet_electronIdx1[169];   //[nJet]
   Int_t           Jet_electronIdx2[169];   //[nJet]
   Int_t           Jet_jetId[169];   //[nJet]
   Int_t           Jet_muonIdx1[169];   //[nJet]
   Int_t           Jet_muonIdx2[169];   //[nJet]
   Int_t           Jet_nConstituents[169];   //[nJet]
   Int_t           Jet_nElectrons[169];   //[nJet]
   Int_t           Jet_nMuons[169];   //[nJet]
   Int_t           Jet_puId[169];   //[nJet]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   Float_t         Tau_rawMVAnewDM2017v2[10];   //[nTau]
   Float_t         Tau_rawMVAoldDM[10];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v1[10];   //[nTau]
   Float_t         Tau_rawMVAoldDM2017v2[10];   //[nTau]
   Float_t         Tau_rawMVAoldDMdR032017v2[10];   //[nTau]
   ...
   UChar_t         Tau_idMVAnewDM2017v2[10];   //[nTau]
   UChar_t         Tau_idMVAoldDM[10];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v1[10];   //[nTau]
   UChar_t         Tau_idMVAoldDM2017v2[10];   //[nTau]
   UChar_t         Tau_idMVAoldDMdR032017v2[10];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[167];   //[nTrigObj]
   Float_t         TrigObj_eta[167];   //[nTrigObj]
   Float_t         TrigObj_phi[167];   //[nTrigObj]
   Float_t         TrigObj_l1pt[167];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[167];   //[nTrigObj]
   Float_t         TrigObj_l2pt[167];   //[nTrigObj]
   Int_t           TrigObj_id[167];   //[nTrigObj]
   Int_t           TrigObj_l1iso[167];   //[nTrigObj]
   Int_t           TrigObj_l1charge[167];   //[nTrigObj]
   Int_t           TrigObj_filterBits[167];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Int_t           Jet_genJetIdx[169];   //[nJet]
   Int_t           Jet_hadronFlavour[169];   //[nJet]
   Int_t           Jet_partonFlavour[169];   //[nJet]
   ...
   UChar_t         Jet_cleanmask[169];   //[nJet]
...
#ifdef nanojpsi_cxx
nanojpsi::nanojpsi(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("D8BCDB81-4844-E811-A71C-0025904C5DE0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("D8BCDB81-4844-E811-A71C-0025904C5DE0.root");
      }
...
Int_t nanojpsi::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t nanojpsi::LoadTree(Long64_t entry)
{
...
void nanojpsi::Init(TTree *tree)
{
   ...
   fChain->SetMakeClass(1);
 	...
 	miniso = new TH1D("mini","mininanojpsimc;mini",30,0,10);
        muonparent= new TH1D("mup","muonparent;pdg",1000,1,1000);
        jpsparent= new TH1D("jp", "jpsiparent;pdg",1000,1,1000);
...
void nanojpsi::Show(Long64_t entry)
{
...
Int_t nanojpsi::Cut(Long64_t entry)
{
