...
#    process.GlobalTag.globaltag = cms.string('101X_dataRun2_Prompt_v3')
...
##    src = cms.InputTag("patMuonsWithTrigger"),
    ...
    cut = cms.string("pt > 15 && passed(8)"+
                     " && pfIsolationR04().sumChargedHadronPt/pt < 0.2 "),#&& !triggerObjectMatchesByCollection('hltIterL3MuonCandidates').empty()"),
)
if TRIGGER != "SingleMu":
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("z2018_dat.root"))
