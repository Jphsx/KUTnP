...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring(#"root://eoscms//eos/cms/store/cmst3/user/botta/TnPtrees/tnpZ_Data.190456-193557.root",
				...
				'file:/home/t3-ku/janguian/CMSSW_10_2_5/src/MuonAnalysis/TagAndProbe/test/zmumu/tnpZ_withEAMiniIso.root'
	...
	pfCombAbsMiniIsoEACorr = cms.vstring("abs miniIso EA", "0", "500", "GeV/c^{2}"),
	...
	Mini = cms.vstring("Mini", "pfCombAbsMiniIsoEACorr", "6")
    ),
