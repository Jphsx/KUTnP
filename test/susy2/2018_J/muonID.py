...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
	...
	tag_dxy = cms.vstring("Tag dxy","0","0.07","cm"),
        ...
        mass   = cms.vstring("Tag-Probe Mass", "2.86", "3.33", "GeV/c^{2}"),
        pt     = cms.vstring("Probe p_{T}", "0", "50", "GeV/c"),
        tag_pt = cms.vstring("Tag p_{T}","0","59","GeV/c"),
        abseta = cms.vstring("Probe |#eta|", "0", "2.5", ""),
        tag_abseta = cms.vstring("Tag |#eta|","0","2.5",""),
#       tag_dxy = cms.vstring("Tag dxy","0","0.07","cm"),
        tag_dz_bestTrack = cms.vstring("Tag dz","0","0.15","cm"),
#       dxy = cms.vstring("Probe dxy","0","0.07","cm"),
        dz_bestTrack = cms.vstring("Probe dz","0","0.15","cm"),
...
#		SIP = cms.vdouble(0.,4.),
	...
	vpvPlusExpoJ = cms.vstring(
	    "Voigtian::signal1(mass, mean1[3.1,3.0,3.2], width[0.00001], sigma1[0.1,0.01,0.3])",
            "Voigtian::signal2(mass, mean1, width,        sigma2[0.1,0.025,0.3])",
            "SUM::signal(vFrac[0.8,0,1]*signal1, signal2)",
            "Exponential::backgroundPass(mass, lp[0,-5,5])",
            "Exponential::backgroundFail(mass, lf[0,-5,5])",
            "efficiency[0.9,0,1]",
...
if "data2018" in scenario:
    ...
    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_17Sep2018_Charmonium_Run2018Av1_GoldenJSON.root", "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_17Sep2018_Charmonium_Run2018Bv1_GoldenJSON.root", "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_17Sep2018_Charmonium_Run2018Cv1_GoldenJSON.root" ]
if "mc2018" in scenario:
   # process.TnP_MuonID.InputFileNames = [ "./tnpJ_withNVtxWeights.root" ]
    process.TnP_MuonID.InputFileNames = ["/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_102XAutumn18_JpsiToMuMu_JpsiPt8_Pythia8_WEIGHT.root" ]
...
if "VeryLoose" in ID:
        ...
        module.Cuts.DZp = cms.vstring("DZp","dz_bestTrack","0.1")
        module.Cuts.DZm = cms.vstring("DZm","dz_bestTrack","-0.1")
...
if "TrigIso24" in ID:
	print("isomu24eta2p1 in numerator")
	module.Categories.IsoMu24_eta2p1 = cms.vstring("isomu24", "dummy[pass=1,fail=0]")
	setattr(module.Efficiencies, "Medium_pt_eta", cms.PSet(
            EfficiencyCategoryAndState  = cms.vstring("IsoMu24_eta2p1", "pass"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(),
            BinToPDFmap = cms.vstring(shape)
...
if "Trig17vvl" in ID:
	print("Mu17 IsoTrkVVL in numerator")
	module.Categories.Mu17_IsoTrkVVL = cms.vstring("mu17vvl", "dummy[pass=1,fail=0]")
        setattr(module.Efficiencies, "Medium_pt_eta", cms.PSet(
            EfficiencyCategoryAndState  = cms.vstring("Mu17_IsoTrkVVL", "pass"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(),
            BinToPDFmap = cms.vstring(shape)
        ))
...
#set binning
pt = cms.vdouble(3.0, 4.0,  5.0, 6.0, 7.0, 9.0, 14.0, 20.0)
abseta = cms.vdouble( 0.0, 1.2, 2.4)
...
if "veryLoose" in scenario:
        ...
        getattr(module.Efficiencies, "Medium_pt_eta").BinnedVariables.tag_dz_bestTrack = cms.vdouble(-0.1,0.1)
        getattr(module.Efficiencies, "Medium_pt_eta").BinnedVariables.dz_bestTrack = cms.vdouble(-0.1,0.1)
...
if "Mu17_IsoTrkVVL" in scenario:
	print("appending trigger mu17_isotrkvvl")
	module.Categories.tag_Mu17_IsoTrkVVL = cms.vstring("mu17isotkvvl", "dummy[pass=1,fail=0]")
        tag_Mu17_IsoTrkVVL = cms.vstring("pass")
        getattr(module.Efficiencies, "Medium_pt_eta").BinnedVariables.tag_Mu17_IsoTrkVVL = tag_Mu17_IsoTrkVVL
...
if "Mu7p5Tk2" in scenario:
        ...
        module.Categories.tag_Mu7p5_Track2_Jpsi_MU = cms.vstring("Mu7p5Tk2", "dummy[pass=1,fail=0]")
        tag_Mu7p5_Track2_Jpsi_MU = cms.vstring("pass")
        getattr(module.Efficiencies, "Medium_pt_eta").BinnedVariables.tag_Mu7p5_Track2_Jpsi_MU = tag_Mu7p5_Track2_Jpsi_MU
