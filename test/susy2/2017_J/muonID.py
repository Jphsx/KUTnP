...
if len(args) >4: syst = args[4]
print "Using modeling systematic variations: ", syst
...
#		SIP = cms.vdouble(0.,4.),
	...
	CBPlusCheb = cms.vstring(
        ...
        vpvPlusCheb = cms.vstring(
            ...
            "Voigtian::signal2(mass, mean1, width,        sigma2[0.1,0.025,0.3])",
            "SUM::signal(vFrac[0.8,0,1]*signal1, signal2)",
            #"CBShape::signal(mass, mean[90,80,100], sigma[3,1,20], alpha[3., 0.5, 5.], n[1, 0.1, 100.])",
...
if "data2017" in scenario:
    ...
    #process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_jpsi_HADD/TnP_SingleMuon2017C_jpsi_1.root", "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_jpsi_HADD/TnP_SingleMuon2017C_jpsi_2.root", "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_jpsi_HADD/TnP_SingleMuon2017C_jpsi_3.root", "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_jpsi_HADD/TnP_SingleMuon2017C_jpsi_4.root" ]
    ...
    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_17Nov2017_Charmonium_Run2017Cv1_Full_GoldenJSON.root", "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_17Nov2017_Charmonium_Run2017Dv1_Full_GoldenJSON.root"]
if "mc2017" in scenario:
    #process.TnP_MuonID.InputFileNames = [ "./tnpJ_withNVtxWeights.root" ]
    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_94X_JpsiToMuMu_Pythia8_WEIGHT.root"]

#current id modes "
#if ID
module = process.TnP_MuonID.clone(OutputFileName = cms.string("./fit_output/TnPJ_MuonID_%s_%s_%s_%s_%s.root" % (scenario, ID, fitmodel,binning,syst)))
...
if "pt2" in binning:
        pt = cms.vdouble(3.0,20.0)


if "syst1" in syst:
        module.Variables.mass = cms.vstring("Tag-Probe Mass", "2.85", "3.31", "GeV/c^{2}")
        module.binsForFit = cms.uint32(30)

if "syst2" in syst:
        module.Variables.mass = cms.vstring("Tag-Probe Mass", "2.87", "3.34", "GeV/c^{2}")
        module.binsForFit = cms.uint32(50)
