...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
	...
	dxy = cms.vstring("Probe dxy","0","0.07","cm"),
        ...
        #shifted window for sensitive sip fits
...
#		SIP = cms.vdouble(0.,4.),
    ...
    PDFs = cms.PSet(
        vpvPlusExpo = cms.vstring(
            "Voigtian::signal1(mass, mean1[90,80,100], width[2.495], sigma1[2,.1,10])",
            "Voigtian::signal2(mass, mean2[90,80,100], width,        sigma2[4,2,10])",
	    #"Voigtian::signal2(mass, mean1, width, sigma2[4,2,10])",
...
#    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_zmumu_HADD/TnP_SingleMuon2017C_zmumu_1.root", "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_zmumu_HADD/TnP_SingleMuon2017C_zmumu_2.root", "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_zmumu_HADD/TnP_SingleMuon2017C_zmumu_3.root", "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_zmumu_HADD/TnP_SingleMuon2017C_zmumu_4.root"]
    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_zmumu_HADD/TnP_SingleMuon2017C_zmumu_1.root"]
if "mc2017" in scenario:
    process.TnP_MuonID.InputFileNames = [ PREFIX+"tnpZ_withNVtxWeights.root" ]
if "Smc2017" in scenario:
    process.TnP_MuonID.InputFileNames = [ PREFIX+"tnpZ_small_0.root" ]
    #process.TnP_MuonID.InputDirectoryName = cms.string('')

    #process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/HADD/tempstorage/TnP_ZmumuM502017.root"]

#current id modes "
#if ID
module = process.TnP_MuonID.clone(OutputFileName = cms.string("./fit_output/TnP_MuonID_%s_%s_%s_%s_%s.root" % (scenario, ID, fitmodel, binning,syst)))
...
if "pt4" in binning:
	pt = cms.vdouble(3,20,45)

if "syst1" in syst:
	module.Variables.mass = cms.vstring("Tag-Probe Mass", "60", "130", "GeV/c^{2}")
	module.binsForFit = cms.uint32(30)

if "syst2" in syst:
	module.Variables.mass = cms.vstring("Tag-Probe Mass", "70", "120", "GeV/c^{2}")
