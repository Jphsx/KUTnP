...
#		SIP = cms.vdouble(0.,4.),
	...
	vpvPlusExpoJ = cms.vstring(
	    #"Voigtian::signal1(mass, mean1[3.1,3.0,3.2], width[0.00001], sigma1[0.1,0.025,0.3])",
            "Voigtian::signal1(mass, mean1[3.1,3.0,3.2], width[0.00001], sigma1[0.04,0.01,0.3])",
	    #"Voigtian::signal2(mass, mean2[3.1,3.0,3.2], width,        sigma2[0.1,0.025,0.3])",
	    "Voigtian::signal2(mass, mean1, width,        sigma2[0.1,0.025,0.3])",
            "SUM::signal(vFrac[0.8,0,1]*signal1, signal2)",# signal2-> (1-vFrac)*signal2
            #"Exponential::backgroundPass(mass, lp[-0.1,-1,0.1])",
            #"Exponential::backgroundFail(mass, lf[-0.1,-1,0.1])",
	    "Exponential::backgroundPass(mass, lp[0,-5,5])",
            "Exponential::backgroundFail(mass, lf[0,-5,5])",
...
#    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2016C_jpsi_HADD/TnP_SingleMuon2016C_jpsi.root" ]
    #process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/SingleMuon/TnP_SingleMuon2017C_jpsi_HADD/TnP_SingleMuon2017C_jpsi_2.root" ]i
    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_LegacyRereco07Aug17_Charmonium_Run2016Bver2_GoldenJSON.root"]
if "mc2016" in scenario:
 #   process.TnP_MuonID.InputFileNames = [ "./tnpJ_withNVtxWeights.root" ]
    process.TnP_MuonID.InputFileNames = [ "/home/t3-ku/janguian/jsingera/TnP/CentralSamples/TnPTreeJPsi_80X_JpsiToMuMu_JpsiPt8_Pythia8_WEIGHT.root"]
...
if "doubleMu4L1L2" in scenario:
	print("appending trigger doubleMu4L1L2")
        module.Categories.tag_DoubleMu4_L1L2 = cms.vstring("doubleMu4L1L2", "dummy[pass=1,fail=0]")
        tag_DoubleMu4_L1L2 = cms.vstring("pass")
        getattr(module.Efficiencies, "Medium_pt_eta").BinnedVariables.tag_DoubleMu4_L1L2 = tag_DoubleMu4_L1L2
